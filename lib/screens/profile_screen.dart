...
import 'personal_details_screen.dart' hide ProfileDetailsProvider, AppTextStyles, UpdateProfiles;
            ...
            child: Column(
              children: [
                _buildListItem(
                  ...
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const PersonalAndKycScreen()));
                  },
                ),
                _buildDivider(),
                _buildListItem(
