  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [_buildBiometricOption()],
        ),
      ),
      ...
      onTap: () {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            backgroundColor: _biometricEnabled ? Colors.green : Colors.orange,
          ),
        );
      },
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Icon(
              icon,
              color: isSelected ? AppTextStyles.navLabel11W600Gold.color : AppTextStyles.navLabel11White60.color,
              size: 24,
            ),
            const SizedBox(height: 4),
            Text(
