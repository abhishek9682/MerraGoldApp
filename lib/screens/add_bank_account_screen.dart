...
class _AddBankAccountScreenState extends State<AddBankAccountScreen> {
  ...
  void initState() {
    super.initState();
  print("Bank cheking details ${widget.bank?.accountHolderName}");
    if (widget.bank != null) {
      ...
      _selectedAccountType = widget.bank!.accountType ?? '';
    }
  }
  ...
  Future<void> _addBankAccount() async {
    ...
    bool success = await provider.addBankAccount(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildTextField('ACCOUNT NUMBER(12 NUMBER)', _accountNumberController, Icons.credit_card, 'Enter account number', keyboardType: TextInputType.number, maxLength: 12),
            const SizedBox(height: 16),
            _buildTextField('CONFIRM ACCOUNT NUMBER(12 NUMBER)', _confirmAccountController, Icons.credit_card, 'Re-enter number', keyboardType: TextInputType.number, maxLength: 12),
            const SizedBox(height: 16),
            _buildTextField('IFSC CODE(11 CHARACTER)', _ifscController, Icons.numbers, 'Enter IFSC', maxLength: 11),
            const SizedBox(height: 16),
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              value: _selectedAccountType.isEmpty ? null : _selectedAccountType,
              isExpanded: true,
    ...
    return InkWell(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(label,
              style:
              selected ? AppTextStyles.navLabel11W600Gold : AppTextStyles.navLabel11White60),
        ],
      ),
    );
  }
