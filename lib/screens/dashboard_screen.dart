...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (!_initialized) {
      ...
      plansProvider.getInvestmentPlans();
  ...
  final List<Map<String, dynamic>> _investmentAmounts = [
    {'amount': '₹100', 'gold': '0.015g'},
    {'amount': '₹500', 'gold': '0.073g'},
    {'amount': '₹1000', 'gold': '0.146g'},
    {'amount': '₹2000', 'gold': '0.292g'},
    {'amount': '₹5000', 'gold': '0.730g'},
    {'amount': '₹10000', 'gold': '1.460g'},
  ];
