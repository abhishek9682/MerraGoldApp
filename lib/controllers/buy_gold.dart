...
class BuyGold with ChangeNotifier {
  PaymentInitiationRequest? _paymentInitiationRequest;

  PaymentInitiationRequest? get paymentInitiationRequest =>
  ...
  Future<bool> buyGold(Map<String, dynamic> body) async {
    try {
      ...
      if (response != null && response["status"]== "success") {
        _paymentInitiationRequest = PaymentInitiationRequest.fromjson(response);
        return true;   // SUCCESS ✔
